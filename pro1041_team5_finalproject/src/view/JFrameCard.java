...
public class JFrameCard extends javax.swing.JFrame {
    ...
    private CardMHinterFace CardSer;

    /**
     * Creates new form JFrameCard
     */
    public JFrameCard() {
        initComponents();
        this.CardSer = new CardMHService();
    }
    ...
    private void loadTable() {
        ...
        for (CardManHinh card : this.CardSer.getAll()) {
            Object[] rowData = {
                card.getId(),
                card.getMa(), card.getLoaiCard()};
            dtm.addRow(rowData);
        }
    }

    public CardManHinh getFormData() {
        String id = lblId.getText().trim();
        String ma = txtMa.getText().trim();
        String loaiCard = txtLoai.getText().trim();
        if (ma.length() == 0
                || loaiCard.length() == 0) {
    ...
    private void tblRamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRamMouseClicked
        ...
        this.txtLoai.setText(dungLuong);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for (i = 0; i < CardSer.getAll().size(); i++) {
            CardManHinh card = CardSer.getAll().get(i);
            if (card.getMa().equalsIgnoreCase(Ma)) {
                JOptionPane.showMessageDialog(this, "Đã tìm thấy ");
                break;
            }
        }
        if (i == CardSer.getAll().size()) {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        // TODO add your handling code here:
        CardManHinh card = this.getFormData();
        if (card == null) {
            return;
        }

        this.CardSer.insert(card);
        this.loadTable();
        this.clearForm();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        this.CardSer.update(card, card.getMa());
        this.loadTable();
        this.clearForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameCard().setVisible(true);
            }
        });
    }
