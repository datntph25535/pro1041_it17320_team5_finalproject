 ...
 * @author DELL
 */
public class JFrameRam extends javax.swing.JFrame {

    private DefaultTableModel defaultTableModel;
    private RamInterface RamSer;

    /**
     * Creates new form JFrameRam
     */
    public JFrameRam() {
        initComponents();
        this.RamSer = new RamService();
    }

    private void loadTable() {
        DefaultTableModel dtm = (DefaultTableModel) this.tblRam.getModel();

        dtm.setRowCount(0);

        for (Ram ram : this.RamSer.getAll()) {
            Object[] rowData = {
                ram.getId(),
                ram.getMa(), ram.getDungLuong()};
            dtm.addRow(rowData);
        }
    }

    public Ram getFormData() {
        String id = lblId.getText().trim();
        String ma = txtMa.getText().trim();
        String dungLuong = txtDL.getText().trim();
        if (ma.length() == 0
                || dungLuong.length() == 0) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtDL, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(58, 58, 58))))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(44, 44, 44)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        this.RamSer.update(ram, ram.getMa());
        this.loadTable();
        this.clearForm();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String idStr = this.tblRam.getValueAt(row, 0).toString();
        this.RamSer.delete(idStr);
        this.loadTable();
        this.clearForm();
    ...
    private void tblRamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRamMouseClicked
        ...
        String idStr = this.tblRam.getValueAt(row, 0).toString();
        String ma = this.tblRam.getValueAt(row, 1).toString();
        String dungLuong = this.tblRam.getValueAt(row, 2).toString();
        this.lblId.setText(idStr);
        this.txtMa.setText(ma);
        this.txtDL.setText(dungLuong);
...
//            return;
//        } else {
//            List<Ram> listRam = RamSer.searchRam(txtSearch.getText().trim());
//
//            if (listRam.isEmpty()) {
...
//        }
        ...
        for (i = 0; i < RamSer.getAll().size(); i++) {
            Ram ram  = RamSer.getAll().get(i);
            if (ram.getMa().equalsIgnoreCase(Ma)) {
                JOptionPane.showMessageDialog(this, "Đã tìm thấy ");
                break;
            }
        }
        if (i == RamSer.getAll().size()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
